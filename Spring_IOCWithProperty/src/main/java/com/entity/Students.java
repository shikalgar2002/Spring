...
public class Students {
	...
	public Students(int stud_id, String stud_name, int stud_age, String stud_city, Country cou) {
		super();
	...
	public String toString() {
		return "Students [stud_id=" + stud_id + ", stud_name=" + stud_name + ", stud_age=" + stud_age + ", stud_city="
				+ stud_city + ", cou=" + cou + "]";
	}
